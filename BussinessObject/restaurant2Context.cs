        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Account>(entity =>
            {
                entity.HasKey(e => e.Aid)
                    .HasName("PK__Account__DE508E2E0092F8E4");
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                entity.HasKey(e => e.Cid)
                    .HasName("PK__Customer__D837D05F9BABB861");
            ...
            modelBuilder.Entity<DepositCate>(entity =>
            {
                entity.HasKey(e => e.DepositId)
                    .HasName("PK__DepositC__AB60DF7110E1161B");
            ...
            modelBuilder.Entity<Food>(entity =>
            {
                entity.HasKey(e => e.Fid)
                    .HasName("PK__Food__D9908D64978E74B8");
            ...
            modelBuilder.Entity<FoodCategory>(entity =>
            {
                entity.HasKey(e => e.Cateid)
                    .HasName("PK__FoodCate__A88C49CC70AB8067");
            ...
            modelBuilder.Entity<Order>(entity =>
            {
                entity.HasKey(e => e.Oid)
                    .HasName("PK__Orders__C2FFCF13F9C27060");
            ...
            modelBuilder.Entity<Reservation>(entity =>
            {
                entity.HasKey(e => e.Rid)
                    .HasName("PK__Reservat__C2B7EDE835D9D934");
            ...
            modelBuilder.Entity<TablesRe>(entity =>
            {
                entity.HasKey(e => e.Tid)
                    .HasName("PK__TablesRe__DC105B0FB041AD52");
